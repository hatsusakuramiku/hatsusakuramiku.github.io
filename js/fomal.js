  ...
  (function ($) {
    $.fn.nekoScroll = function (option) {
      var defaultSetting = {
        ...
        borderRadius: 5 + 'px',
        right: 55.6 + 'px',
        nekoImg: "https://aws.mikufans.date/hexo/img/other/cat.png",
        hoverMsg: "春天啦~",
...
function createtime() {
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9 ?
      `<img class='boardsign' src='https://aws.mikufans.date/hexo/badge/%E5%88%9D%E6%A8%B1%E6%9C%AA%E6%9D%A5-%E4%B8%8A%E8%AF%BE%E6%91%B8%E9%B1%BCing-39C5BB.svg' title='今天也是在被数学欺负呢~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>` :
      `<img class='boardsign' src='https://aws.mikufans.date/hexo/badge/%E5%88%9D%E6%A8%B1%E6%9C%AA%E6%9D%A5-%E7%A2%8E%E8%A7%89ing-39C5BB.svg' title='唔...被床封印啦~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://aws.mikufans.date/hexo/img/background/100723659_p0.webp);
    --darkmode-bg:url(https://aws.mikufans.date/hexo/img/background/92364287.webp);
    --mobileday-bg: url(https://aws.mikufans.date/hexo/img/background/100723659_p0.webp);
    --mobilenight-bg: url(https://aws.mikufans.date/hexo/img/background/92364287.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/100513742_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/100513742_p0.webp)')"><span style="color: black;">PID:100513742_p0</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/100723659_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/100723659_p0.webp)')"><span style="color: black;">PID:100723659_p0</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/100886812_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/100886812_p0.webp)')"><span style="color: black;">PID:100886812_p0</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/100891310_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/100891310_p0.webp)')"><span style="color: black;">PID:100891310_p0</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/102673006_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/102673006_p0.webp)')"><span style="color: black;">PID:102673006_p0</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/102673006_p1.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/102673006_p1.webp)')"><span style="color: black;">PID:102673006_p1</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/102673006_p2.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/102673006_p2.webp)')"><span style="color: black;">PID:102673006_p2</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/102879503_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/102879503_p0.webp)')"><span style="color: black;">PID:102879503_p0</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/104627387_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/104627387_p0.webp)')"><span style="color: black;">PID:104627387_p0</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/105903003_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/105903003_p0.webp)')"><span style="color: black;">PID:105903003_p0</a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/phone/105475620_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/phone/105475620_p0.webp)')"><span style="color: black;">PID:105475620_p0</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/phone/105596080_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/phone/105596080_p0.webp)')"><span style="color: black;">PID:105596080_p0</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/phone/106047122_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/phone/106047122_p0.webp)')"><span style="color: black;">PID:106047122_p0</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/phone/32740714_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/phone/32740714_p0.webp)')"><span style="color: black;">PID:32740714_p0</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/phone/57877623_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/phone/57877623_p0.webp)')"><span style="color: black;">PID:57877623_p0</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/phone/60223956_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/phone/60223956_p0.webp)')"><span style="color: black;">PID:60223956_p0</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/phone/63709645_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/phone/63709645_p0.webp)')"><span style="color: black;">PID:63709645_p0</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/phone/65582627_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/phone/65582627_p0.webp)')"><span style="color: black;">PID:65582627_p0</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/phone/66965508_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/phone/66965508_p0.webp)')"><span style="color: black;">PID:66965508_p0</a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://aws.mikufans.date/hexo/img/background/phone/67394923_p0.webp)" class="pimgbox" onclick="changeBg('url(https://aws.mikufans.date/hexo/img/background/phone/67394923_p0.webp)')"><span style="color: black;">PID:67394923_p0</a></div>
              </div>
            </details>
